...
major_xticks1 = np.arange(0, 0.21, 0.05)
minor_xticks1 = np.arange(0, 0.21, 0.01)
major_yticks1 = np.arange(0.2, 1.01, 0.2)
minor_yticks1 = np.arange(0.2, 1, 0.04)

ax1 = plt.subplot(221)
plt.scatter(alpha, Cl, s = 1)
...
major_xticks2 = np.arange(0, 0.21, 0.05)
minor_xticks2 = np.arange(0, 0.21, 0.01)
major_yticks2 = np.arange(0.02, 0.081, 0.02)
minor_yticks2 = np.arange(0.02, 0.081, 0.004)

ax2 = plt.subplot(222)
plt.scatter(alpha, Cd, s = 1)
plt.title('$Cd-\u03B1$', fontsize = 10)
plt.ylabel('Drag coeficient $Cd$ [$-$]', fontsize = 7)
plt.xlabel('Angle of attack $\u03B1$ [$deg$]', fontsize = 7)
ax2.set_xticks(major_xticks2)
ax2.set_xticks(minor_xticks2, minor=True)
...
major_xticks3 = np.arange(0, 0.09, 0.02)
minor_xticks3 = np.arange(0, 0.09, 0.004)
major_yticks3 = np.arange(0.2, 1.01, 0.2)
minor_yticks3 = np.arange(0.2, 1.01, 0.04)

ax3 = plt.subplot(223)
plt.scatter(Cd, Cl, s = 1)
...
ax3.set_yticks(major_yticks3)
ax3.set_yticks(minor_yticks3, minor=True)
plt.grid(which = 'minor', alpha=0.2)
plt.grid(which = 'major', alpha = 0.5)

major_xticks4 = np.arange(0, 0.9, 0.2)
minor_xticks4 = np.arange(0, 0.9, 0.04)
major_yticks4 = np.arange(0.02, 0.081,0.02)
minor_yticks4 = np.arange(0.02, 0.081, 0.004)

ax4 = plt.subplot(224)
plt.scatter(Cl_check, Cd, s = 1)
...
ax4.set_xticks(major_xticks4)
ax4.set_xticks(minor_xticks4, minor=True)
ax4.set_yticks(major_yticks4)
ax4.set_yticks(minor_yticks4, minor=True)
...
print(min(Reynolds), max(Reynolds))
print(min(Mach), max(Mach))
